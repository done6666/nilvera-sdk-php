...
try {
    ...
    // 2. Yeni seri oluştur
    // -------------------------------------------------------------------
    $newSeries = $client->eArchive()->createSeries(
    ...
    // -------------------------------------------------------------------
    $detail = $client->eArchive()->getSeries($seriesId);
    ...
    // -------------------------------------------------------------------
    $updated = $client->eArchive()->updateSeries(
    ...
    // Değişikliği doğrula
    $after = $client->eArchive()->getSeries($seriesId);
