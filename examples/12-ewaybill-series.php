...
try {
    ...
    $newSeries  = $client->eWaybill()->createSeries(
    ...
    // -------------------------------------------------------------------
    $detail = $client->eWaybill()->getSeries($seriesId);
    ...
    // -------------------------------------------------------------------
    $updated = $client->eWaybill()->updateSeries(
    ...
    // Değişikliği doğrula
    $after = $client->eWaybill()->getSeries($seriesId);
